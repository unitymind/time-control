	...
	jQuery.railsAutocomplete.fn.extend({
	    ...
	    $(e).autocomplete({
				...
				source: function( request, response ) {
                    ...
                    filter_by:  getFilterBy($(e).attr('filter_by')),
                    scope: $(e).attr('scope')
					}, response );
				},
				search: function() {
				...
				select: function( event, ui ) {
					...
					if (e.delimiter != null) {
                        ...
                        if ($(this).attr('scope_to')) {
                            try {
                                $($(this).attr('scope_to')).attr('scope', $(this).attr('scope'));
                                $($(this).attr('scope_to')).attr('filter_by', $(this).attr('id_element'));
                            } catch (er) {
                                alert(er);
                            }
                        }
